...
public:
	...
	void DrawRectGraph(const int& posx0, const int& posy0,const int& posx1, const int& posy1, const int& posx2, const int& posy2, bool trns) noexcept {
		if (this->handle_ != -1) {
			DxLib::DrawRectGraph(posx0, posy0, posx1, posy1, posx2, posy2, this->handle_, (trns ? TRUE : FALSE),FALSE);
		}
	}
	//GetGraphSize
